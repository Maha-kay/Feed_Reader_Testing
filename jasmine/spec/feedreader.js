...
$(function() {
    ...
    */
    ...
    describe('menu',function() {
        hiddenMenu = $('body').hasClass('menu-hidden');
        hamburgerMenu = $('.menu-icon-link');
    ...
    describe('New Feed Selection',function() {
        ...
        // Check the newsfeed  html to be not same as previous.
         it('should change feed content after loading feed',function() {
            expect($('.feed').html()).not.toEqual(initFeedSelection);
         });
     });
}());